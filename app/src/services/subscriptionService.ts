// Subscription Service - RevenueCat Wrapper for AI Beer Sommelier
import Purchases, {
  PurchasesPackage,
  CustomerInfo,
  PurchasesOfferings,
...
export const PRODUCTS = {
  PREMIUM_MONTHLY: 'beer_sommelier_premium_monthly',
  PREMIUM_YEARLY: 'beer_sommelier_premium_yearly',
} as const;
